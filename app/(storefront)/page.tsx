...
export const metadata: Metadata = {
  ...
  description:
    'Drapperr Drift is Kota\'s most popular clothing store. Shop trendy T-shirts, hoodies, denim, and streetwear for men. Visit us at Shubh Affinity, Swami Vivekananda Nagar, Kota or order online across India.',
  keywords: [
